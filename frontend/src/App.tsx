...
function App() {
 ...
 //     console.log("Menu button:", menuButton, "Backdrop:", backdrop, "Window width:", window.innerWidth);
  ...
  useEffect(() => {
   // console.log("Effect triggered: showRecommendations =", showRecommendations, "hasMessages =", hasMessages);
